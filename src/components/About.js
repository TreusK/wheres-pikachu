  ...
  return (
    <div className="About container">
      <div className="aboutInfoContainer box">
        ...
        <p className="subtitle is-6">Following <a href='https://www.theodinproject.com' target="_blank" rel="noopener noreferrer">TOP</a>, this project was about 
        ...
        of the image altogether, etc.
        I gave up on that because it was too much work to create a "new" game logic and state management
        ...
        <div className='otherContainer'>
          ...
          <div className='projectCard'>
            <div className='card'>
              <div className="card-image">
                ...
                <a href='https://treusk.github.io/2do/' target='_blank' rel="noopener noreferrer"><img src={projectTodo} alt="todo project preview" /></a>
                </figure>
              </div>
              <div className="content">
                <p>Simple Todo List, very original <br/>
                I like simple looking things <br/>
                github repo - <a href="https://github.com/TreusK/2do" target='_blank' rel="noopener noreferrer">here</a> </p>
              </div>
            </div>
          </div>
          ...
          <div className='projectCard'>
            <div className='card'>
              <div className="card-image">
                <figure className="image is-16by9">
                <a href='https://treusk.github.io/lm2react/' target='_blank' rel="noopener noreferrer"><img src={projectMulana2} alt="lamulana project preview" /></a>
                </figure>
              </div>
              <div className="content">
              <p>I was playing La Mulana 2 and needed a place to take notes<br/>
                Even then, I got filtered<br/>
                github repo - <a href="https://github.com/TreusK/lm2react" target='_blank' rel="noopener noreferrer">here</a> </p>
              </div>
            </div>
          </div>
          ...
          <div className='projectCard'>
            <div className='card'>
              <div className="card-image">
                <figure className="image is-16by9">
                <a href='https://treusk.github.io/bookShopCart/' target='_blank' rel="noopener noreferrer"><img src={projectBookshopCart} alt="shopcart project preview" /></a>
                </figure>
              </div>
              <div className="content">
              <p>Uggo looking shopping cart with fake bookstore attached<br/>
                Creating each book obj was a thing<br/>
                github repo - <a href="https://github.com/TreusK/bookShopCart" target='_blank' rel="noopener noreferrer">here</a> </p>
              </div>
            </div>
          </div>
          ...
          <div className='projectCard'>
            <div className='card'>
              <div className="card-image">
                <figure className="image is-16by9">
                <a href='https://treusk.github.io/TicTacToe/' target='_blank' rel="noopener noreferrer"><img src={projectTTT} alt="ttt project preview" /></a>
                </figure>
              </div>
              <div className="content">
                <p>It doesn't get any more basic than a Tic Tac Toe<br/>
                <br/>
                github repo - <a href="https://github.com/TreusK/TicTacToe" target='_blank' rel="noopener noreferrer">here</a> </p>
              </div>
            </div>
          </div>
          ...
          <div className='projectCard'>
            <div className='card'>
              <div className="card-image">
                <figure className="image is-16by9">
                  <a href='https://treusk.github.io/memory-game/' target='_blank' rel="noopener noreferrer"><img src={projectJpMemory} alt="memory project preview" /></a>
                </figure>
              </div>
              <div className="content">
                <p>Simple memory game, but with japanese words<br/>
                I still can't read anything more difficult than Kuma Bear<br/>
                github repo - <a href="https://github.com/TreusK/memory-game" target='_blank' rel="noopener noreferrer">here</a> </p>
              </div>
            </div>
          </div>
          ...
          <div className='projectCard'>
            <div className='card'>
              <div className="card-image">
                <figure className="image is-16by9">
                  <a href='https://treusk.github.io/cvUp/' target='_blank' rel="noopener noreferrer"><img src={projectCvPreview} alt="cvPreview project preview" /></a>
                </figure>
              </div>
              <div className="content">
                <p>Fill some forms and get a plain looking CV preview back<br/>
                No, you can't download it either<br/>
                github repo - <a href="https://github.com/TreusK/cvUp" target='_blank' rel="noopener noreferrer">here</a> </p>
              </div>
            </div>
          </div>
        </div>
